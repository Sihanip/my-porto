    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/hanif-nur/" target="_blank">
                  <Linkedin />
                </a>
                <a href="https://x.com/fidingmemo" target="_blank">
                  <Twitter />
                </a>
                <a href="https://www.instagram.com/_hhanip/" target="_blank">
                  <Instagram />
                </a>
                <a href="https://github.com/Sihanip" target="_blank">
                  <Github />
                </a>
              </div>
            </div>
          ...
          <div
            className="bg-card px-8 rounded-lg shadow-xs"
